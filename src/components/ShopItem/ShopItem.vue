<template>
    <div class="Item">
      <img class="bigImg" src="https://yanxuan.nosdn.127.net/17b1f75f167c06763a550486f197d852.jpg?imageView&thumbnail=345y345&quality=95" alt="">
      <div class="title">严选4周年经典品榜</div>
      <div class="footer">
        <div class="user">
